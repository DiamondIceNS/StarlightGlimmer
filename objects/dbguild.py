class DbGuild:
    def __init__(self, guild_id, name, join_date, prefix, alert_channel, autoscan, canvas, language, template_admin, template_adder, bot_admin, faction_name, faction_alias, faction_color, faction_desc, faction_emblem, faction_invite):
        self.id = guild_id
        self.name = name
