STRINGS = {
    ...
    "general.help_ending_note": "Digite '{0}{1} <command>' para mais informações do comando.",
    "general.ping": "Pinging...",
    "general.pong": "Pong! | **{0}ms**",
    "general.suggest": "Sua sugestão foi enviada. Obrigado por sua contribuição!",
    "general.version": "O numero da minha versão é **{0}**",
