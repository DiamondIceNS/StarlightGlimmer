STRINGS = {
    ...
    "brief.canvas.pixelplace": "Sets the default canvas to Pixelplace.fun.",
    ...
    "brief.diff.pixelplace": "Creates a diff using Pixelplace.fun.",
    ...
    "brief.ditherchart.pixelplace": "Gets a dither chart of Pixelplace.fun colors.",
    ...
    "brief.online.pixelplace": "Shows how many players are currently online on Pixelplace.fun.",
    "brief.ping": "Pong!",
    ...
    "brief.preview.pixelplace": "Creates a preview using Pixelplace.fun.",
    ...
    "brief.quantize.pixelplace": "Quantizes colors using the palette of Pixelplace.fun.",
    ...
    "brief.template.add.pixelplace": "Adds a template for Pixelplace.fun.",
    ...
    "brief.template.check.pixelplace": "Check the completion status of all Pixelplace.fun templates.",
    ...
    "signature.diff.pixelplace": "(-e) <coordinates> (zoom)",
    ...
    "signature.preview.pixelplace": "<coordinates> (zoom)",
    ...
    "signature.template.add.pixelplace": "<name> <x> <y> (url)",
    ...
    "example.diff.pixelplace": [("100 100", "(with an attachment) Check an image against Pixelplace.fun at (100, 100)"),
                                 ("100 100 7", "(with an attachment) Check an image against Pixelplace.fun at (100, 100) and magnify the result 7 times")],
    ...
    "example.preview.pixelplace": [("900 900", "Preview Pixelplace.fun centered on (900, 900)"),
                                    ("900 900 7", "Preview Pixelplace.fun centered on (900, 900) magnified 7 times"),
                                    ("900 900 -7", "Preview Pixelplace.fun centered on (900, 900) zoomed out 7 times")],
    ...
    "example.quantize.pixelplace": [("", "(with an attachment) Quantize an attachment to the palette of Pixelplace.fun"),
                                    ("MyTemplate", "Quantize a template named 'MyTemplate' to the palette of Pixelplace.fun")],
    ...
    "example.template.add.pixelplace": [("MyTemplate 100 100", "(with an attachment) Create a template named 'MyTemplate' for Pixelplace.fun at (100, 100)"),
                                         ("MyTemplate 100 100 https://cdn.discordapp.com/.../avatar.jpg", "Create a template named 'MyTemplate' for Pixelplace.fun at (100, 100) using the image at the URL")],
    ...
    "color.pixelplace.0": "White",
    "color.pixelplace.1": "Light Grey",
    "color.pixelplace.2": "Dark Grey",
    "color.pixelplace.3": "Black",
    "color.pixelplace.4": "Pink",
    "color.pixelplace.5": "Red",
    "color.pixelplace.6": "Orange",
    "color.pixelplace.7": "Brown",
    "color.pixelplace.8": "Yellow",
    "color.pixelplace.9": "Light Green",
    "color.pixelplace.10": "Green",
    "color.pixelplace.11": "Cyan",
    "color.pixelplace.12": "Teal",
    "color.pixelplace.13": "Blue",
    "color.pixelplace.14": "Light Purple",
    "color.pixelplace.15": "Purple",
}
